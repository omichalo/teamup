...
console.log('🔧 Configuration des variables d\'environnement Firebase Functions...');

try {
  // Configuration FFTT
  console.log('📋 Configuration des identifiants FFTT...');
  execSync('firebase functions:config:set fftt.id="SW251" fftt.pwd="XpZ31v56Jr" fftt.club_code="08781477"', { stdio: 'inherit' });
