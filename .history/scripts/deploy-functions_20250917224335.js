...
async function getFunctionUrls() {
  try {
    ...
    console.log("\n📋 URLs des Functions:");
    console.log(
      "   - Synchronisation manuelle: [PROJECT_ID]-[REGION]-syncPlayersManual"
    );
    console.log(
      "   - Logs de synchronisation: [PROJECT_ID]-[REGION]-getSyncLogs"
    );
    console.log(
      "   - Test connexion FFTT: [PROJECT_ID]-[REGION]-testFFTTConnection"
    );
  } catch (error) {
    console.error(
