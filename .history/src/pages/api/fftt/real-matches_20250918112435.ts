          ...
          if (hasScore) {
            ...
            try {
              ...
              if (equipeIds) {
                ...
                try {
                  console.log(`Tentative d'appel API avec équipes: ${equipeIds.equipe1} vs ${equipeIds.equipe2}`);
                  ...
                  console.log(`✅ Détails récupérés avec succès pour ${equipe.libelle}:`, detailsRencontre);
                } catch (apiError) {
