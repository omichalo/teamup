      ...
      try {
        ...
        for (let index = 0; index < rencontres.length; index++) {
          ...
          if (rencontre.journee) {
            ...
            // Solution temporaire : utiliser l'index pour simuler les journées
            journee = Math.floor(index / 2) + 1; // 2 matchs par journée approximativement
          }
          ...
          if (
            ...
            rencontre.date &&
            rencontre.date !== "0000-00-00" &&
            rencontre.date !== "0000-00-00 00:00:00"
          ) {
