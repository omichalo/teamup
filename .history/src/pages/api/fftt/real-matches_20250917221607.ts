    ...
    for (const equipe of equipes) {
      try {
        ...
        for (const rencontre of rencontres) {
          ...
          const isHome = rencontre.equipeA?.libequipe?.includes("SQY PING") || 
                        rencontre.equipeA?.libequipe?.includes("SQY PING");
          
          // Déterminer l'adversaire
          const opponent = isHome ? 
            rencontre.equipeB?.libequipe || "Adversaire inconnu" :
            rencontre.equipeA?.libequipe || "Adversaire inconnu";
          ...
          if (rencontre.dateprevi) {
            ...
            matchDate = new Date(); // Date par défaut
          }
