    ...
    for (const equipe of equipesFiltered) {
      try {
        ...
        for (let index = 0; index < rencontres.length; index++) {
          ...
          // Pour l'instant, on ne récupère pas les détails pour éviter les appels API lents
          // TODO: Implémenter la récupération des détails seulement pour les matchs terminés
