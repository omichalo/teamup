    ...
    for (const equipe of equipes) {
      try {
        ...
        for (let index = 0; index < rencontres.length; index++) {
          ...
          if (rencontre.dateReelle && rencontre.dateReelle !== "0000-00-00" && rencontre.dateReelle !== "0000-00-00 00:00:00") {
            matchDate = new Date(rencontre.dateReelle);
          } else if (rencontre.datePrevue && rencontre.datePrevue !== "0000-00-00" && rencontre.datePrevue !== "0000-00-00 00:00:00") {
