                ...
                if (clubnum1Match && clubnum2Match) {
                  try {
                    ...
                    if (score) {
                      const equip1Match = rencontre.lien.match(/equip_1=([^&]+)/);
                      const equip2Match = rencontre.lien.match(/equip_2=([^&]+)/);
                      const isSQYPingEquip1 = equip1Match && equip1Match[1].includes("SQY+PING");
                      
                      const res1 = parseInt(rencontre.lien.match(/res_1=([^&]+)/)?.[1] || "0");
                      const res2 = parseInt(rencontre.lien.match(/res_2=([^&]+)/)?.[1] || "0");
                      ...
                      console.log(`✅ Détails basiques créés pour ${equipe.libelle}`);
                    }
                  }
                }
