    ...
    for (const equipe of equipes) {
      try {
        ...
        for (const rencontre of rencontres) {
          ...
          // Essayer différentes propriétés possibles pour la date
          if (rencontre.dateprevi && rencontre.dateprevi !== "0000-00-00" && rencontre.dateprevi !== "0000-00-00 00:00:00") {
            matchDate = new Date(rencontre.dateprevi);
          } else if (rencontre.daterencontre && rencontre.daterencontre !== "0000-00-00" && rencontre.daterencontre !== "0000-00-00 00:00:00") {
            matchDate = new Date(rencontre.daterencontre);
          } else if (rencontre.date && rencontre.date !== "0000-00-00" && rencontre.date !== "0000-00-00 00:00:00") {
            matchDate = new Date(rencontre.date);
          } else {
            // Calculer une date basée sur la saison et la journée
