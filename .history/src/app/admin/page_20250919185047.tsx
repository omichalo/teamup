                ...
                <Card>
                  <CardContent>
                    ...
                    <Typography
                      ...
                      sx={{ mb: 2 }}
                    >
                      Synchronise les matchs organisés par équipe dans des sous-collections Firestore.
                    </Typography>
                ...
                <Card>
                  <CardContent>
                    ...
                    <Box sx={{ pl: 2 }}>
                      ...
                      <Typography variant="body2" sx={{ mb: 1 }}>
                        • <strong>Matchs :</strong> Synchronisation quotidienne
                        à 2h du matin
                      </Typography>
                      <Typography variant="body2" sx={{ mb: 1 }}>
                        • <strong>Matchs par équipe :</strong> Synchronisation quotidienne
                        à 2h30 du matin
                      </Typography>
                      <Typography variant="body2">
