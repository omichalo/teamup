                                    ...
                                    .map((match, index) => (
                                      ...
                                      >
                                        <Card
                                          ...
                                          sx={{ 
                                            height: "100%",
                                            cursor: match.resultatsIndividuels ? "pointer" : "default",
                                            transition: "all 0.2s ease-in-out",
                                            "&:hover": match.resultatsIndividuels ? {
                                              boxShadow: 3,
            ...
            <Box>
              ...
              {selectedMatch.score && (
                <Box sx={{ mb: 3 }}>
                  ...
                  <Box sx={{ 
                    p: 2, 
                    bgcolor: selectedMatch.result === "VICTOIRE" ? "success.light" : 
                            selectedMatch.result === "DEFAITE" ? "error.light" : "grey.100",
                    borderRadius: 1,
                    textAlign: "center"
                  }}>
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  <List>
                    {selectedMatch.rencontreId && (
                      <ListItem>
                        <ListItemText
                          primary="ID Rencontre"
                          secondary={selectedMatch.rencontreId}
                        />
                      </ListItem>
                    )}
                    {selectedMatch.equipeIds && (
                      <ListItem>
                        <ListItemText
                          primary="IDs Équipes"
                          secondary={`${selectedMatch.equipeIds.equipe1} vs ${selectedMatch.equipeIds.equipe2}`}
                        />
                      </ListItem>
                    )}
                    {selectedMatch.resultatsIndividuels.status && (
                      <ListItem>
                        <ListItemText
                          primary="Statut"
                          secondary={selectedMatch.resultatsIndividuels.status}
                        />
                      </ListItem>
                    )}
                    {selectedMatch.resultatsIndividuels.note && (
                      <ListItem>
                        <ListItemText
                          primary="Note"
                          secondary={selectedMatch.resultatsIndividuels.note}
                        />
                      </ListItem>
                    )}
                  </List>
              ...
              <Box>
                ...
                <Divider sx={{ mb: 2 }} />
                <Typography variant="body2" color="text.secondary">
                  Les résultats individuels détaillés seront disponibles une fois que l'API FFTT 
                  fournira les compositions et résultats des joueurs pour ce match.
                </Typography>
              </Box>
            </Box>
          )}
