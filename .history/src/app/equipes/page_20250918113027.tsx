            ...
            <Box>
              ...
              {process.env.NODE_ENV === 'development' && (
                <Box sx={{ mb: 2, p: 2, bgcolor: 'grey.100', borderRadius: 1 }}>
                  <Typography variant="caption" component="pre">
                    Debug - resultatsIndividuels: {JSON.stringify(selectedMatch.resultatsIndividuels, null, 2)}
                  </Typography>
                </Box>
              )}
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        >
                          ...
                          >
                           ...
                           {selectedMatch.resultatsIndividuels.joueursA && Object.entries(
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        >
                          ...
                          >
                           ...
                           {selectedMatch.resultatsIndividuels.joueursB && Object.entries(
              ...
              {selectedMatch.resultatsIndividuels && (
                  <Box sx={{ mb: 3 }}>
                    ...
                    <Divider sx={{ mb: 2 }} />
                     {selectedMatch.resultatsIndividuels.parties && selectedMatch.resultatsIndividuels.parties.map(
                       (partie, index) => (
                        <Box
                          key={index}
                          sx={{
              ...
              <Box>
                ...
                <Grid container spacing={2}>
                  {selectedMatch.resultatsIndividuels &&
                    selectedMatch.resultatsIndividuels.expectedScoreEquipeA !==
                      undefined && (
                      <>
                        <Grid item xs={6}>
                          <Typography variant="body2" color="text.secondary">
                            <strong>Score attendu Équipe A:</strong>{" "}
                            {
                              selectedMatch.resultatsIndividuels
                                .expectedScoreEquipeA
                            }
                          </Typography>
                        </Grid>
                        <Grid item xs={6}>
                          <Typography variant="body2" color="text.secondary">
                            <strong>Score attendu Équipe B:</strong>{" "}
                            {
                              selectedMatch.resultatsIndividuels
                                .expectedScoreEquipeB
                            }
                          </Typography>
                        </Grid>
                      </>
                  ...
                  {selectedMatch.equipeIds && (
                    <Grid item xs={12}>
                      <Typography variant="body2" color="text.secondary">
                        <strong>IDs Équipes:</strong>{" "}
                        {selectedMatch.equipeIds.equipe1} vs{" "}
                        {selectedMatch.equipeIds.equipe2}
                      </Typography>
                    </Grid>
                  )}
                </Grid>
