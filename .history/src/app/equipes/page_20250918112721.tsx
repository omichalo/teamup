                                    ...
                                    .map((match, index) => (
                                      ...
                                      >
                                        <Card
                                          ...
                                          sx={{
                                            height: "100%",
                                            cursor: match.resultatsIndividuels
                                              ? "pointer"
                                              : "default",
        ...
        <DialogContent dividers>
          {selectedMatch && (
            <Box>
              ...
              {selectedMatch.resultatsIndividuels && selectedMatch.resultatsIndividuels.joueursA && (
                <Box sx={{ mb: 3 }}>
                  <Typography variant="h6" gutterBottom>
                    Compositions des équipes
                  </Typography>
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={6}>
                      <Box sx={{ p: 2, bgcolor: "primary.light", borderRadius: 1 }}>
                        <Typography variant="h6" sx={{ mb: 2, color: "primary.contrastText" }}>
                          {selectedMatch.resultatsIndividuels.nomEquipeA || "Équipe A"}
                        </Typography>
                        {Object.entries(selectedMatch.resultatsIndividuels.joueursA).map(([nomComplet, joueur]) => (
                          <Box key={nomComplet} sx={{ mb: 1, p: 1, bgcolor: "white", borderRadius: 1 }}>
                            <Typography variant="body1" sx={{ fontWeight: "bold" }}>
                              {joueur.prenom} {joueur.nom}
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                              Licence: {joueur.licence} • Points: {joueur.points}
                            </Typography>
                          </Box>
                        ))}
                      </Box>
                    ...
                    <Grid item xs={12} md={6}>
                      <Box sx={{ p: 2, bgcolor: "secondary.light", borderRadius: 1 }}>
                        <Typography variant="h6" sx={{ mb: 2, color: "secondary.contrastText" }}>
                          {selectedMatch.resultatsIndividuels.nomEquipeB || "Équipe B"}
                        </Typography>
                        {Object.entries(selectedMatch.resultatsIndividuels.joueursB).map(([nomComplet, joueur]) => (
                          <Box key={nomComplet} sx={{ mb: 1, p: 1, bgcolor: "white", borderRadius: 1 }}>
                            <Typography variant="body1" sx={{ fontWeight: "bold" }}>
                              {joueur.prenom} {joueur.nom}
                            </Typography>
              ...
              {selectedMatch.resultatsIndividuels && selectedMatch.resultatsIndividuels.parties && (
                <Box sx={{ mb: 3 }}>
                  <Typography variant="h6" gutterBottom>
                    Résultats des parties
                  </Typography>
                  <Divider sx={{ mb: 2 }} />
                  {selectedMatch.resultatsIndividuels.parties.map((partie, index) => (
                    <Box key={index} sx={{ mb: 2, p: 2, border: 1, borderColor: "grey.300", borderRadius: 1 }}>
                      ...
                      {partie.setDetails && partie.setDetails.length > 0 && (
              ...
              <Box>
                ...
                <Divider sx={{ mb: 2 }} />
                <Grid container spacing={2}>
                  {selectedMatch.resultatsIndividuels && selectedMatch.resultatsIndividuels.expectedScoreEquipeA !== undefined && (
                    <>
                      <Grid item xs={6}>
                        <Typography variant="body2" color="text.secondary">
                          <strong>Score attendu Équipe A:</strong> {selectedMatch.resultatsIndividuels.expectedScoreEquipeA}
                        </Typography>
                      </Grid>
                      <Grid item xs={6}>
                        <Typography variant="body2" color="text.secondary">
                          <strong>Score attendu Équipe B:</strong> {selectedMatch.resultatsIndividuels.expectedScoreEquipeB}
                        </Typography>
                      </Grid>
                    </>
                  )}
                  {selectedMatch.rencontreId && (
                    <Grid item xs={12}>
                      <Typography variant="body2" color="text.secondary">
                        <strong>ID Rencontre:</strong> {selectedMatch.rencontreId}
                      </Typography>
                    </Grid>
                  )}
                  {selectedMatch.equipeIds && (
                    <Grid item xs={12}>
                      <Typography variant="body2" color="text.secondary">
                        <strong>IDs Équipes:</strong> {selectedMatch.equipeIds.equipe1} vs {selectedMatch.equipeIds.equipe2}
                      </Typography>
                    </Grid>
                  )}
                </Grid>
