          ...
          <Tabs value={tabValue} onChange={handleTabChange} sx={{ mb: 3 }}>
            {epreuves.map((epreuve, index) => (
              <Tab
                ...
                icon={<SportsTennis />}
                sx={{
                  color: epreuve.includes('Féminin') ? 'secondary.main' : 'primary.main',
                  '&.Mui-selected': {
                    color: epreuve.includes('Féminin') ? 'secondary.main' : 'primary.main',
                  }
                }}
            ...
            tabValue === index && (
              <Box key={epreuve}>
                {equipesByEpreuve[epreuve].length === 0 ? (
                  <Alert severity="info">Aucune équipe trouvée pour cette épreuve.</Alert>
                ) : (
                  ...
                  <Accordion 
                    ...
                    sx={{ 
                      mb: 2,
                      borderLeft: `4px solid ${epreuve.includes('Féminin') ? '#f57c00' : '#1976d2'}`
                    }}
                  >
                    <AccordionSummary expandIcon={<ExpandMore />}>
                      ...
                      >
                        ...
                        <Chip
                          ...
                          color={epreuve.includes('Féminin') ? 'secondary' : 'primary'}
                          size="small"
                          sx={{ mr: 2 }}
                        />
                      </Box>
