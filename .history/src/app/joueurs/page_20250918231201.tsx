    ...
    <AuthGuard>
      <Layout>
        <Box sx={{ p: 3 }}>
                  ...
                  <TableBody>
                    {filteredPlayers.map((player) => (
                      <TableRow key={player.id} hover>
                        ...
                        <TableCell>{getGenderChip(player.isFemale)}</TableCell>
                        <TableCell>
                          {getNationalityChip(player.isForeign)}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
          ...
          >
            <Typography variant="body2" color="text.secondary">
              <strong>Note :</strong> Cette page affiche les données synchronisées depuis Firestore. 
              Les données sont mises à jour automatiquement via les Cloud Functions.
            </Typography>
          </Box>
        </Box>
      </Layout>
