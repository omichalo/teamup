      ...
      <Layout>
        <Box sx={{ p: 3 }}>
          <Alert severity="error">
            ...
            {playersError || teamsError || journeesError}
          </Alert>
        </Box>
      </Layout>
    );
    ...
    <Layout>
      <Box>
        ...
        <Typography variant="subtitle1" color="text.secondary" gutterBottom>
          {players.length} joueurs, {teams.length} équipes et {journees.length}{" "}
          journées chargés depuis FFTT
        </Typography>
          ...
          <Grid xs={12} md={4}>
            <Box sx={{ display: "flex", gap: 1 }}>
              <Button
                ...
                disabled={
                  !teamCompositions[selectedTeam]?.A || selectedJournee === null
                }
              >
                Valider
              </Button>
