...
export const useAuthState = () => {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, async (firebaseUser) => {
      console.log("Hook useAuth: État d'authentification changé:", firebaseUser?.email);
      setFirebaseUser(firebaseUser);

      if (firebaseUser) {
        try {
          console.log("Hook useAuth: Utilisateur Firebase trouvé, recherche dans Firestore...");
