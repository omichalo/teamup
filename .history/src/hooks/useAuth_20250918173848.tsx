  ...
  const signIn = async (email: string, password: string) => {
    try {
      ...
      if (error.code === "auth/invalid-credential") {
        console.log("Hook useAuth: Identifiants invalides - erreur gérée silencieusement");
        // Ne pas re-lancer l'erreur, juste définir l'utilisateur comme null
        setUser(null);
      ...
      if (error.code === "auth/user-not-found") {
        console.log("Hook useAuth: Utilisateur non trouvé - erreur gérée silencieusement");
        setUser(null);
        setFirebaseUser(null);
        return;
      }
      ...
      if (error.code === "auth/wrong-password") {
        console.log("Hook useAuth: Mot de passe incorrect - erreur gérée silencieusement");
        setUser(null);
        setFirebaseUser(null);
        return;
      }

      // Pour les autres erreurs, les re-lancer
      console.log("Hook useAuth: Erreur non gérée, re-lancement:", error.code);
      throw error;
    } finally {
      setLoading(false);
    }
