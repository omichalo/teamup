...
export class PlayerSyncService {
   ...
   */
  private async getPlayerDetails(licence: string): Promise<Record<string, unknown> | null> {
    try {
   ...
   */
  private mergePlayerData(baseJoueur: FFTTJoueur, details: Record<string, unknown> | null): FFTTJoueurDetails {
