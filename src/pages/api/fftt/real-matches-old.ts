...
export default async function handler(
  ...
  try {
    ...
    console.log(
      ...
      // Paralléliser la récupération des matchs pour toutes les équipes
            ...
            try {
              ...
              if (equipeIds) {
                ...
                try {
                  ...
                  const clubnum1Match =
                    rencontre.lien.match(/clubnum_1=([^&]+)/);
                  const clubnum2Match =
                    rencontre.lien.match(/clubnum_2=([^&]+)/);
                  ...
                  // Signature: getDetailsRencontreByLien(lienRencontre, idClubEquipeA, idClubEquipeB)
                  ...
                  console.log(
                    `❌ Erreur API, création d'un objet basique:`,
                    apiError
                  );
