...
/**
 * GET - Récupère la liste des membres du serveur Discord
 * 🛡️ Sentinel: Accès restreint aux ADMIN et COACH pour protéger les PII des membres Discord
 * (ID, noms d'utilisateur, noms d'affichage)
 */
