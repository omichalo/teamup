  ...
  async () => {
    try {
      ...
      do {
        ...
        console.log(
          "[Discord Members] Requête URL:",
          url.replace(DISCORD_TOKEN || "", "[TOKEN_HIDDEN]")
        );
        ...
        console.log(
          "[Discord Members] Status de la réponse:",
          response.status,
          response.statusText
        );
        ...
        console.log(
          "[Discord Members] Membres non-bots ajoutés:",
          members.length
        );
      ...
      console.log(
        "[Discord Members] Total de membres récupérés:",
        members.length
      );
