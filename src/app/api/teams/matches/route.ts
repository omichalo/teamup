...
export async function GET(req: Request) {
  try {
    // Vérifier la session et les permissions (ADMIN ou COACH requis pour voir les compositions et matchs)
    ...
    // Sécurité : Empêcher la mise en cache des données sensibles
